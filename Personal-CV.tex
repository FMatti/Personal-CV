    ...
    rowspan=\headboxheight}
{
    ...
    \de{\titlefont{Computational Scientist}}
}
    ...
    rowspan=\mainboxheight}
{
    ...
    \begin{tabular}{>{\footnotesize}rl}
        ...
        \en{Since}\de{Seit} 09/2021
            ...
            \de{\textbf{EPFL, Master of Science}} \\
        ...
        \en{Since}\de{Seit} 09/2022
            & \en{\textbf{EPFL, Machine Learning Assistant}}
            \de{\textbf{EPFL, Assistent für Machine Learning}} \\
            & \en{Master course CS-433 on foundations of ML}
            \de{Master Vorlesung CS-433 zu Grundlagen von ML} \\
            & \smallspace
        
        \en{Since}\de{Seit} 09/2022
            & \en{\textbf{EPFL, Programming Concepts Assistant}}
            \de{\textbf{EPFL, Assistent für Programming Concepts}} \\
            & \en{Master course MATH-458 on C\texttt{++} programming} 
            \de{Master Vorlesung MATH-458 in C\texttt{++}} \\
            & \smallspace
        ...
        \en{Since}\de{Seit} 06/2018
            ...
            \de{Führungsgehilfe des Bataillonskommandant} \\
            & \en{In charge of NBC instruction of 700 soldiers}
            \de{Zuständig für ABC Ausbildung von 700 Soldaten} \\
            & \smallspace

        \en{Since}\de{Seit} 12/2014
            & \en{\textbf{Skiclub Zweisimmen, Alpine Skiing Teacher}}
            \de{\textbf{Skiklub Zweisimmen, Ski-Trainer}} \\
            & \largespace
           ...
           rowspan=\footboxheight}
{
    ...
    {\scriptsize \en{Find the source code and a digital version of this CV at}
                 \de{Finde den Quellcode und eine digitale version dieses Lebenslaufes unter} \href{https://github.com/FMatti/Personal-CV}{github.com/FMatti/Personal-CV} }
